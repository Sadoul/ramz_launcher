...
$Global:RAMZE_ROOT      = Split-Path -Parent $PSScriptRoot   # = engine-patches/
$Global:RAMZE_ORIGINAL  = Join-Path $RAMZE_ROOT 'original'
$Global:RAMZE_PATCHES   = Join-Path $RAMZE_ROOT 'patches'
...
$Global:RAMZ        = 'C:\Users\smopo\AppData\Roaming\.ramz\modpacks\ramz'
$Global:RAMZ_VER    = Join-Path $RAMZ 'versions'
